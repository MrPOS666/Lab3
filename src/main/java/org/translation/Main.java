...
//        Translator translator = new InLabByHandTranslator();
    ...
    private static String promptForCountry(CountryCodeConverter translator) {
        List<String> countries = translator.fromCountry();
...
//        System.out.println(countries);
        ...
        for (String country : countries) {
            countryNames.add(translator.fromCountry(country));
        }
    ...
    // Note: CheckStyle is configured so that we don't need javadoc for private methods
    private static String promptForLanguage(LanguageCodeConverter translator, String languages) {
            // Convert the language codes to their names (assuming Translator provides such functionality)
            List<String> languageNames = new ArrayList<>();
            for (String language : languages) {
                languageNames.add(translator.fromLanguageCode(language)); // Assuming fromLanguageCode() method exists
            }
        ...
        // TODO Task: convert the language codes to the actual language names before sorting
            System.out.println("Select a language from the list below:");
